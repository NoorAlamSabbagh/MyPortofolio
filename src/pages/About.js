        ...
        <div className="container">
            ...
            <div className="left">
              ...
              <div className="about__info">
                <PText>
                  ...
                  multicultural city that flourished as a North Indian cultural
                  and artistic hub. I love art and design. I always try to
          ...
          <div className="about__info__items">
            <div className="about__info__item">
              ...
              <AboutInfoItem
                title="Matriculation"
                items={['Sri Raghukul Vidyapeeth, Gonda, UP']}
              />
              <AboutInfoItem
                title="Intermediate"
                items={['Red Rose Senior Secondary School, Lucknow']}
              />
              <AboutInfoItem
                title="University"
                items={['Faculty of Engineering Lucknow University, Lucknow']}
              />
            </div>
            <div className="about__info__item">
